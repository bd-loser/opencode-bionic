...
echo "  cp $BINARY_PATH \$PREFIX/bin/opencode"
echo "  chmod +x \$PREFIX/bin/opencode"
echo "  opencode --version"
echo ""
echo "To run directly:"
echo "  $BINARY_PATH"
echo ""
echo "Note: the binary still needs the LD_PRELOAD shim for FFI. If you install"
echo "to \$PREFIX/bin/opencode, create a wrapper like bun's launcher:"
echo "  #!/data/data/com.termux/files/usr/bin/bash"
echo "  export MEMTAG_OPTIONS=off"
echo "  export LD_PRELOAD=/data/data/com.termux/files/usr/lib/bun-termux/libbun-android-fix.so"
echo "  exec /data/data/com.termux/files/usr/lib/opencode/opencode \"\$@\""
